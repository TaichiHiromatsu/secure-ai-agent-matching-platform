...
| Functional Score | 40点 | 40% | 機能の正確性 |
...
## 2. Functional Score (機能スコア) - 最大40点

### 目的
エージェントが本来の機能を正しく実行できるかを評価します。
...
### パラメータ
- **passed_scenarios**: 機能テストで正しく動作したシナリオ数
- **total_scenarios**: 実行した機能テストシナリオの総数

### 評価基準
- エージェントカードに記載された機能やユースケースに基づいてテストシナリオを生成
- RAGTruthデータセットを使用した質問応答タスクで評価
- 応答の正確性を距離メトリクスで測定
...
### 重み付けの理由
- **Functional (40%)**: エージェントの基本機能が最も重要
