...
if [ "$DEPLOY_ENV_VARS" != \
     "EPHEMERAL_CLOUD_RUN_DEMO=true,MEDIATION_STORE_MODE=memory,APP_ENV=ephemeral-demo,DEV_MODE=false,GOOGLE_GENAI_USE_VERTEXAI=true,GOOGLE_CLOUD_PROJECT=gen-lang-client-0585901015,GOOGLE_CLOUD_LOCATION=global" ]; then
